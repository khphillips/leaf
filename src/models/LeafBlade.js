...
export default class LeafBlade extends ObjModel{
  ...
  static fields () {
    return {
      ...
      vein_angle_length_curve_x1 : this.attr(.45),
      vein_angle_length_curve_y1 : this.attr(.32),
      vein_angle_length_curve_x2 : this.attr(.7),
      vein_angle_length_curve_y2 : this.attr(.07),
      vein_angle_length_curve_repeat : this.attr(1),
